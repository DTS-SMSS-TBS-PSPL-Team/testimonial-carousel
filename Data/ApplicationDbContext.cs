...
namespace TS.Data
{
    public class ApplicationDbContext : IdentityDbContext<RegisteredUser, IdentityRole<int>, int>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            //builder.Entity<ApplicantTestimonial>()
            //    .Property(at => at.ApplicantProfileId).HasColumnName("Applicant_Profile_ID");
        ...
        public DbSet<CarouselSliderImages> CarouselSliderImages { get; set; }
